    ...
    public class EbayUploader:IEbayUploader
    {
        ...
        public void RefreshOrCreateEbayArticle(List<IArticle> articlesToRefresh, string fileName)
        {
            ...
            foreach (var article in articlesToRefresh)
            {
                ...
                ebayType.MotorsGermanySearchable = false;
                ...
                ebayType.PrimaryCategory = new CategoryType();
                //ebayType.PrimaryCategory.CategoryID = "66471";
                ebayType.PrimaryCategory.CategoryID = "11104";
        ...
        private ShippingDetailsType GetShippingDetails()
        {
            ...
            st1.ShippingServiceAdditionalCost = new AmountType() { Value = 3.3, currencyID = CurrencyCodeType.EUR };
